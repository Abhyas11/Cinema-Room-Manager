...
public class Cinema {
        ...
        while(run) {
            ...
            switch(val) {
                ...
                case 2:
                    ...
                    int priceOfTicket = ticketPrice(rows, seats, rowNum);
                    System.out.println("Ticket price: $"+priceOfTicket);
                    income += priceOfTicket;
                ...
                case 3:
                    ...
                    String formattedNumber = String.format("%.2f", purchasedTicketsPercentage);
                    System.out.println("Percentage: " +formattedNumber+"%");
    ...
    public static int ticketPrice(int rows, int seats, int rowNum){
        int ticketPrice;
        if(rows*seats>60){
            if(rowNum<=rows/2){
                ticketPrice = 10;
